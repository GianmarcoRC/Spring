...
@Component
@Order(10)
public class EJ7C implements CommandLineRunner {
    private final Faker faker;
    private final MessageService messageService;
    private final Contador contador1;


    public EJ7C(Faker faker, @Qualifier("systemOutMessageService") MessageService messageService, Contador contador1) {
        this.faker = faker;
    ...
    public void run(String... args) throws Exception {
        messageService.showMessage(" Personaje " + faker.gameOfThrones().character());
